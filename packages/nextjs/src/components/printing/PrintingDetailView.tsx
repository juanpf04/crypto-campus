...
/**
 * PrintingDetailView — Detalle de un trabajo de impresión.
 *
 * Layout a 2 columnas:
...
export function PrintingDetailView({ basePath }: PrintingDetailViewProps) {
  ...
  if (!log) {
    return (
      <div className="space-y-6">
        <BackLink href={`${basePath}/history`} label="Volver al historial" />
