...
/**
 * Recompensas de una asignatura (admin).
 */
...
export default function AdminOfferingRewardsPage() {
    ...
    <div className="space-y-6">
      ...
      {rewards.length === 0 ? (
        <EmptyState
          ...
          description="Aún no se ha creado ninguna recompensa en esta asignatura."
        />
      ) : (
