/**
 * ShopCartLayoutClient — Cliente que monta CartProvider + ShopCartDrawer +
 * FloatingCartButton + PurchaseOverlay para todas las páginas de la tienda.
 *
 * Se renderiza desde `layout.tsx` (server component) que primero pasa por
 * ModuleGuard. Si el módulo Shop está pausado, los usuarios no-admin nunca
 * llegan aquí (server-side block).
 */
...
export function ShopCartLayoutClient({ children }: { children: ReactNode }) {
  return (
    <CartProvider>
