...
/**
 * Lista de tareas de UNA asignatura impartida.
 * Filtro por estado (OPEN/REVIEWING/CLOSED) + búsqueda.
 */
...
export default function ProfessorOfferingAssignmentsPage() {
        ...
        <EmptyState
          ...
          description={
            assignments.length === 0
              ? "Aún no has creado ninguna tarea en esta asignatura."
