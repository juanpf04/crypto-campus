...
export default function AdminNewRoomPage() {
  ...
  async function handleSubmit(data: RoomFormData) {
    ...
    router.push("/dashboard/admin/library/rooms");
  }

  return (
    <div className="space-y-6">
      <BackLink href="/dashboard/admin/library/rooms" label="Volver a salas" />
      <h1 className="text-2xl font-bold text-text">Crear sala</h1>
      <Card className="max-w-2xl mx-auto p-6"><RoomForm onSubmit={handleSubmit} /></Card>
    </div>
  );
}
