...
export default function StudentItemDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <BackLink href="/dashboard/student/library" label="Volver a biblioteca" />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <Card className="p-5 space-y-4">
            ...
            >
              {item.availableCopies > 0 ? "Solicitar préstamo" : "Sin copias disponibles"}
            </Button>

            <p className="text-xs text-text-muted text-center">
              Se requiere 1 LibraryToken como depósito
            </p>
          </Card>
        </div>
      </div>
